...
parser.add_argument('--num_runs', type=int, default=10000, help='number of image samples')
...
parser.add_argument('--resfile', type=str, default='result_black_simba.json', help='suffix appended to save file')
